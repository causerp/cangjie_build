...
This guide is designed to help users: set up the Cangjie SDK build environment in macOS systems and build a complete `mac-ohos` Cangjie SDK with all components.
...
export SDK_NAME=mac-aarch64-ohos # or mac-x64-ohos
```
