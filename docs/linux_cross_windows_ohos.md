...
本指导书用于指导用户：在 Linux 系统中搭建 Cangjie SDK 构建环境及集成构建包含全部组件的 `windows-x64-ohos` Cangjie SDK。
...
[请参考编译ohos-x86_64、ohos-aarch64工具链](linux_ohos_toolchain.md)](linux_ohos_toolchain.md)
